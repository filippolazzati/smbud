...
\begin{lstlisting}
PUT somministrazioni-vaccini-latest/_mapping
{
  "runtime": {
    "dosi_totali": {
      "type": "long",
...
In this section are provided screenshots of the various visualizations created on the Kibana Dashboard and a brief explanation of the information contained in each of them.
\begin{itemize}
    \item \textbf{Overview of the vaccine doses administrations}
    \begin{figure}
        \centering
    ...
    \end{figure}
    \item \textbf{Doses administration by region, visualized on the Italian territory}
    \begin{figure}
        \centering
        ...
        \label{fig:map}
    \end{figure}
    \item \textbf{Administered doses per supplier}
    \begin{figure}
        \centering
    ...
    \end{figure}
    \item \textbf{Weekly administered doses, grouped by various metrics}
    \begin{figure}
        \centering
    ...
    \end{figure}
    \item \textbf{Overview of the vaccine deliveries}
    \begin{figure}
        \centering
    ...
    \end{figure}
    \item \textbf{Weekly delivered/administered doses comparison}
    \begin{figure}
        \centering
